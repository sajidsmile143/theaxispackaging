...
import { CORRUGATED_OPTIONS } from "@/lib/constants"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"
import { ArrowRight, Package, Factory, Shield, ChevronLeft, ChevronRight } from "lucide-react"
import { Link } from "react-router-dom"

export default function CorrugatedOptionsPage() {
  const [currentPage, setCurrentPage] = useState(1)
  const itemsPerPage = 4
  const totalPages = Math.ceil(CORRUGATED_OPTIONS.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const endIndex = startIndex + itemsPerPage
  const currentItems = CORRUGATED_OPTIONS.slice(startIndex, endIndex)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[var(--axis-dark-blue)] to-[var(--axis-mid-blue)] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Explore different flute types and corrugated options to find the perfect balance 
            of strength, cushioning, and printability for your packaging needs.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600">Flute Types</p>
            </div>
            <div className="flex flex-col items-center">
      ...
      {/* Corrugated Options Grid */}
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--axis-dark-blue)] mb-4">
              Browse Corrugated Options
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from our range of flute types, each offering different characteristics 
              for strength, cushioning, and printability.
            </p>
          </div>
      ...
      <section className="py-16 bg-[var(--axis-dark-blue)] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Our corrugated experts can help you select the perfect flute type for your specific needs. 
