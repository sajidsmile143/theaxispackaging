...
import { CORRUGATED_INSPIRATIONS } from "@/lib/constants"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"
import { ArrowRight, Package, Factory, Shield, ChevronLeft, ChevronRight } from "lucide-react"
import { Link } from "react-router-dom"

export default function CorrugatedInspirationsPage() {
  const [currentPage, setCurrentPage] = useState(1)
  const itemsPerPage = 4
  const totalPages = Math.ceil(CORRUGATED_INSPIRATIONS.length / itemsPerPage)
  const startIndex = (currentPage - 1) * itemsPerPage
  const endIndex = startIndex + itemsPerPage
  const currentItems = CORRUGATED_INSPIRATIONS.slice(startIndex, endIndex)
      ...
      <section className="bg-gradient-to-r from-[var(--axis-dark-blue)] to-[var(--axis-mid-blue)] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Get inspired by our creative corrugated packaging concepts and see how brands 
            are designing their packaging to make an impact.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600">Inspiration Categories</p>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[var(--axis-dark-blue)] mb-4">
              Browse Corrugated Inspirations
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover creative packaging concepts and get inspired by innovative 
              corrugated solutions from various industries.
            </p>
          </div>
      ...
      <section className="py-16 bg-[var(--axis-dark-blue)] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let our design team help you create innovative corrugated packaging that inspires 
            and makes an impact. Start your creative journey today!
          </p>
